---
title: "Political theories by Anthony Downs"
author:
- name: Héloïse GOETHALS
  affiliation: Sciences Po Bordeaux
...
fontsize: 11pt
endnote: no
keywords: theories, political sciences, Downs, researches, political parties
...
Theories of political disagreement often envisage ideology as a single, latent dimension that structures politics on a continuum between left and right [@downs1957economic]. Anthony Downs was born in 21 of November of 1930 and he is an american economist and he introduces the left-right axis in his seminal worl "An Exonomic Theory of Democracy". `r lorem::ipsum(2, avg_words_per_sentence = 15)`
...
```{r, eval=TRUE, echo=FALSE, size="small", fig.cap="The percentage of vote for each candidate in the 2016 U.S. election.", out.width="75%", fig.align="center"}
library(tidyverse)
library(anesr)
...
[^one_footnote]:Footnotes are very important to add some informations to your document or authors o books.
